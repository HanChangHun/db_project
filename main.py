...
from src.getbarcode import read_barcode

mainLayout = uic.loadUiType("ui/mainWindow.ui")[0]
signinLayout = uic.loadUiType("ui/signIn.ui")[0]
initialLayout = uic.loadUiType("ui/initialLayout.ui")[0]
